...
// v1 free, v2/v3 $4.99 per period, no subscription — pay for how many months you need
object BillingSkus {
    const val V2_30D = "kai_v2_30d" // $4.99 30 days
    const val V2_90D = "kai_v2_90d" // $12.99 90 days
    const val V3_30D = "kai_v3_30d" // $4.99 when v3 ships
    const val V3_90D = "kai_v3_90d"
    val all = listOf(V2_30D, V2_90D, V3_30D, V3_90D)
}
...
class BillingManager(private val ctx: Context) : PurchasesUpdatedListener {
    ...
    // expiry timestamps (ms) — 0 = not owned
    ...
    override fun onPurchasesUpdated(result: BillingResult, purchases: MutableList<Purchase>?) {
        ...
        for (p in purchases) {
            ...
            // Consume so user can buy again (pay for how many months you need)
